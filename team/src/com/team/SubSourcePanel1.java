...
public class SubSourcePanel1 extends JPanel {
...
//   int sourceNum2;
//   JScrollPane scroll;   
   public SubSourcePanel1(DBConn conn, CustomMenu customMenu) {
    ...
    private void addSourceButton(String text, int index, int sourceNum, String sourceName, int sourcePrice) {
        ...
        sourceButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                customMenu.lb_select_sourceImage2.setIcon(scaledIcon);
                customMenu.lb_select_sourceImage2.setHorizontalAlignment(SwingConstants.CENTER);
                customMenu.lb_select_sourceImage2.setVerticalAlignment(SwingConstants.CENTER);
                
                customMenu.lb_select_sourceName2.setText(clickedSourceName);
                customMenu.lb_select_sourceName2.setHorizontalAlignment(JLabel.RIGHT);

                customMenu.lb_select_sourcePrice2.setText(""+clickedSourcePrice);
                customMenu.lb_select_sourcePrice2.setHorizontalAlignment(JLabel.LEFT);
                
                price2=Integer.parseInt(customMenu.lb_select_sourcePrice2.getText());
            }
        });
